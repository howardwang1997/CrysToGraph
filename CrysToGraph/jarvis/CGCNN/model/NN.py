...
class CrysToGraphNet(nn.Module):
    ...
    def forward(self, data, contrastive=True):
        ...
        nbr_fea = self.gf[0].expand(nbr_fea[:,0]).float()
        ...
        for idx in range(len(self.convs)):
            atom_fea, nbr_fea_ = self.do_mp(self.convs[idx], atom_fea, nbr_fea_idx, nbr_fea)
    ...
    def do_mp(self, conv_n, atom_fea, nbr_fea_idx, nbr_fea):
        atom_fea, nbr_fea_ = conv_n(atom_fea, nbr_fea_idx, nbr_fea)
